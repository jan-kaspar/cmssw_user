string dir_base = "tb,round1-short/324462.166-251/103,104,105,123,124,125/ev=1E4,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t";
...
string rpSets[];
pen rps_pens[];
rpSets.push("103, 123"); rps_pens.push(heavygreen);

rpSets.push("104, 124"); rps_pens.push(black);
rpSets.push("103, 104, 123, 124"); rps_pens.push(yellow);
