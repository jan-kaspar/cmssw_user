string dir_base = "tb,round1-short/324462.166-251/3,4,5,23,24,25-excl1981939712,2023555072/ev=1E4,pl=3,units=2,ovlp=f,3rpsInO=t/s+sr,std,1rotzIt=0,eMuMvRot=t";
...
string rpSets[];
pen rps_pens[];
rpSets.push("3, 23"); rps_pens.push(heavygreen);

rpSets.push("4, 24"); rps_pens.push(black);
//rpSets.push("3, 4, 23, 24"); rps_pens.push(yellow);
