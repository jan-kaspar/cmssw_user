...
int main()
{
  ...
  vector<RPInfo> rpInfos = {
    { "L_1_F", "sector 45", 2.0, 11.0 },
    { "L_1_N", "sector 45", 2.0, 11.0 },
    { "R_1_N", "sector 56", 0., 0. },
    { "R_1_F", "sector 56", 2.0, 7.0 },
  };
  ...
  for (const auto &lhcSet : lhcSettings)
  {
    ...
    for (const auto &rpInfo : rpInfos)
    {
      ...
      // get input
      string fn_in_hor = "/afs/cern.ch/work/j/jkaspar/work/analyses/elastic/6500GeV/ctpps-2016-september/master/DS-run-10325/alignment.root";
      ...
      string fn_in_vert = "/afs/cern.ch/work/j/jkaspar/work/analyses/ctpps/alignment/2016_postTS2/data/alig-version2/fill_5322/xangle_140/DS1/distributions.root";
