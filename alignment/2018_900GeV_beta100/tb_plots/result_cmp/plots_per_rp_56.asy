...
inputs.push(prefix + "324462.166-336" + postfix); input_pens.push(blue);
inputs.push(prefix + "324532.399-520" + postfix); input_pens.push(red);
inputs.push(prefix + "324536.360-509" + postfix); input_pens.push(heavygreen);
